 ...
 */
public class CollectingLoan extends javax.swing.JFrame {

    /** Creates new form CollectingLoan */
    public CollectingLoan() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CollectingLoan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CollectingLoan().setVisible(true);
            }
        });
    }
