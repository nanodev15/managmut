...
public class TestPanel1 extends JPanel {
    ...
    public TestPanel1() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
...
//        return new ImageIcon((URL)getResource("clouds.jpg"));
        return new ImageIcon("clouds.jpg");
    }
