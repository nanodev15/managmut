...
public class CreditPanelAutom1 extends javax.swing.JPanel {
    ...
    public CreditPanelAutom1() {
      ...
      public CreditPanelAutom1(Boolean freely) {
        initComponents();
    ...
    public void setDateOri(Date date){
        demoDateField1.setDate(date);
    }
...
//    }
    ...
    public Double getMontant () {
     ...
     public int getNbPeriod () {
        if(jTextField3.getText().isEmpty()) return -1;
    ...
    public Double getrate() {
        if(jTextField6.getText().isEmpty()) return 0d;
    ...
    private void initComponents() {
        ...
        demoDateField1.setFieldEnabled(false);
