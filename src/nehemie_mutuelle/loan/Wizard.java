...
public class Wizard extends WindowAdapter implements PropertyChangeListener
{
  ...
  public Wizard(Boolean freely)
  {
    ...
    private void initComponents()
    {
        ...
        if (freely)  wizardController = new WizardController(this, freely);
        else wizardController = new WizardController(this);
