 ...
 */
public class loanew extends javax.swing.JPanel {
...
public Vector getallpersmor()  throws SQLException, ParseException {
     ...
     PreparedStatement prepr = conn.prepareStatement ("SELECT Raison_sociale, IdProfil_persmorale FROM Profil_adulte ORDER BY Raison_sociale");
     ResultSet rs = prepr.executeQuery();
     while(rs.next()) {
...
public Vector getalladults()  throws SQLException, ParseException {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Données présaisies", "Saisies au fur et à mesure", "Remboursement au terme" }));
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(104, 104, 104)
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jComboBox1, 0, 276, Short.MAX_VALUE)
                            .add(jComboBox2, 0, 276, Short.MAX_VALUE)
        ...
        jTabbedPane1.addTab("Données 1/2", jPanel1);

        jLabel3.setText("Frais de dossier");

        jLabel8.setText("Montant de l'emprunt");

        jLabel4.setText("Frais de suivi");
        ...
        jTabbedPane1.addTab("Données 2/2", jPanel2);
