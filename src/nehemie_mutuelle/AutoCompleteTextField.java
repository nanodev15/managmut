...
public class AutoCompleteTextField {
    ...
    public AutoCompleteTextField() {
        listSomeString.add("-");
        listSomeString.add("0001 ABASSA");
        listSomeString.add("0002 Rowing");
        listSomeString.add("0006 Knitting");
        listSomeString.add("1949 Speed reading");
        listSomeString.add("0007 Pool");
        listSomeString.add("0039 None of the above");
//
